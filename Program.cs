...
namespace ConsoleApp1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Note note1 = new Note();
            note1.Name = "ДР";
            note1.Description = "День рождения у Игоря 1 января";
            note1.Date = new DateTime(2022, 10, 19);
            notes.Add(note1);

            Note note2 = new Note();
            note2.Name = "Проверка";
            note2.Description = "Эта заметка создана только для отладки кода.";
